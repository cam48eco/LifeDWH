...
INSERT INTO [dbo].[#csvlist]([filenames], [depth], [csvfile]) EXEC master.dbo.xp_dirTree 'C:\communities', 1, 1;
...
SET @csvpath= 'C:\communities\' + (SELECT filenames FROM [dbo].[#csvlist] WHERE id = 1)
...
BEGIN
	...
	SET @csvpath = 'C:\communities\' + (SELECT filenames FROM [dbo].[#csvlist] WHERE id = @Counter)
