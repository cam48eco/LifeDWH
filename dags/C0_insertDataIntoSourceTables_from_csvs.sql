...
INSERT INTO [dbo].[#csvlist]([filenames], [depth], [csvfile]) EXEC master.dbo.xp_dirTree '/home/pawelc/dwlife', 1, 1;
...
SET @csvpath= '/home/pawelc/dwlife/' + (SELECT filenames FROM [dbo].[#csvlist] WHERE id = 1)
...
BEGIN
	...
	SET @csvpath = '/home/pawelc/dwlife/' + (SELECT filenames FROM [dbo].[#csvlist] WHERE id = @Counter)
