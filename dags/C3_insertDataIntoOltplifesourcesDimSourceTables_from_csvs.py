...
with DAG('C3_insertDataIntoOltplifesourcesDimSourceTables_from_csvs',
...
# Tasks definitions 
    ...
    print_insertintosourcetables = BashOperator(task_id='Print_info',
                               bash_command='echo "I am inserting / updating data into source tables in oltplife from csvs: communities"')
    ...
    exe_createandfeedtablesfromcsv = MsSqlOperator(
       ...
       sql="C3_insertDataIntoOltplifesourcesDimSourceTables_from_csvs.sql",
       dag=dag,
     )
