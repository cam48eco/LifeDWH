...
def retrieveobservationdatafromgoogle ():
    import gdown
    # Url for google drive directory with 33 files with observations
...
def retrievecommunitiesdatafromgoogle ():
    import gdown
    # Url for google drive directory with 1 file with communities details
...
with DAG('C_PythonRetrieveFolderPreSourceDataFromGoogleSheets',
