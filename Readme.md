...
According to above mentioned assumptions, in the case of tables with data on: observations and communities, the respective tables in oltplifestaging are feeded with tables from oltplifesources database with respective [DAG and and accompanying T-SQL (C2)](https://github.com/cam48eco/LifeDWH/tree/main/dags) with some minor transformations.
